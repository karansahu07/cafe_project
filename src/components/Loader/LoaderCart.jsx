...
const Loader = ({ color = "#961818", trackColor = "#cacaca20" }) => {
  return (
    <div
      className="preloader"
      style={{
        "--primary": color,       // animated stroke color
        "--track": trackColor,    // background track color
      }}
    >
      <svg
        className="cart"
      ...
      >
        <g fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="8">
          {/* 👇 Ye hi grey background tha, ab dynamic */}
          <g className="cart__track" stroke="var(--track)">
